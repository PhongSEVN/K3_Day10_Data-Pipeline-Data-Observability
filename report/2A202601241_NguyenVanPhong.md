...
| ------------------ | --------------------- | ---------------- | ----------------- | -------------------------------------------- |
| Baseline orchestration | `src/pipelines/phase1.py` | Raw/clean/embedding/eval từ các module khác | Baseline metrics, `data/reports/phase1_report.md` và đầy đủ artifact pha 1 | [Hoàn thành/Một phần/Chưa hoàn thành] |
| Corruption flow orchestration | `src/pipelines/corruption_flow.py` | Cleaned baseline + corruption module | Corrupted/repaired metrics, `data/reports/corruption_report.md`, comparison report | [Hoàn thành/Một phần/Chưa hoàn thành] |
